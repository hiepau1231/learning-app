...
const timeline = [
  {
    Logo: Logo1,
    heading: "Lãnh Đạo",
    Description: "Cam kết hoàn toàn vào sự thành công của công ty",
  },
  {
    Logo: Logo2,
    heading: "Trách Nhiệm",
    Description: "Học viên luôn là ưu tiên hàng đầu của chúng tôi",
  },
  {
    Logo: Logo3,
    heading: "Linh Hoạt",
    Description: "Khả năng thay đổi là một kỹ năng quan trọng",
  },
  {
    Logo: Logo4,
    heading: "Giải Quyết Vấn Đề",
    Description: "Lập trình để tìm ra giải pháp",
  },
];
