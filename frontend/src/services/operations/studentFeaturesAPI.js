...
import rzpLogo from "../../assets/Logo/logo_full_light.png"
import { setPaymentLoading } from "../../slices/courseSlice";
import { resetCart } from "../../slices/cartSlice";


const { COURSE_PAYMENT_API, COURSE_VERIFY_API, SEND_PAYMENT_SUCCESS_EMAIL_API, COURSE_ENROLLMENT_API } = studentEndpoints;
...
// ================ enrollCourse ================
export async function enrollCourse(token, coursesId, userDetails, navigate, dispatch) {
    const toastId = toast.loading("Đang đăng ký khóa học...");

    try {
        const enrollResponse = await apiConnector(
            "POST",
