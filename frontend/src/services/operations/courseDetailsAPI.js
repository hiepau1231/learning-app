...
export const addCourseDetails = async (data, token) => {
    ...
    try {
        ...
        result = response?.data?.data;
        toast.success("Nội dung khoá học thêm thành công");
    } catch (error) {
...
export const createSection = async (data, token) => {
    ...
    try {
        ...
        toast.success("Nội dung các phần khoá học tạo thành công");
    } catch (error) {
...
export const createTest = async (data, token) => {
    ...
    try {
        const response = await apiConnector("POST", CREATE_TEST_API, data, {
            Authorization: `Bearer ${token}`,
        });
